...
#include "ff.h"  /* Aporta els tipus BYTE, UINT, LBA_t, WORD, DWORD, etc. */
...
#define CTRL_TRIM           4   /* Inform device that sector data is no longer used */

/* Generic commands (Not used by FatFs) */
#define CTRL_POWER          5   /* Get/Set power status */
#define CTRL_LOCK           6   /* Lock/Unlock media removal */
#define CTRL_EJECT          7   /* Eject media */
#define CTRL_FORMAT         8   /* Create physical format on media */
